...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Blog Kevin perfil</h1>", unsafe_allow_html=True)
    ...
    texto = """
    Mi nombre es Kevin Alonso Trujillo Villanueva y vivo en Lima, Los Olivos. Estudio la carrera de Publicidad en la Universidad Pontificia Católica del Perú. Lo que me gusta de mi carrera es que puedo desarrollar mi habilidades creativas en diferentes trabajos de los cursos y matizarlas en sus respectivas presentaciones. Sobre mi futuro, me gustaría tener mi propia agencia de publicidad. Por otro lado, en mi tiempo libre me gusta jugar fútbol. 
    """
    ...
    texto_2 = """
    Al principio del curso me sentí confundido y pesimista por no entender los temas de programación en Python, pero en el transcurso del curso pude entender con mayor práctica los temas de programación. Por ejemplo, me gustó la parte de interactuar con el usuario al trabajar con el código input, así como determinar las posibilidades en sus respuestas del usuario con if, else y… . En el futuro, me gustaría que los conocimientos que he adquirido de programación me sirvan para comprender cómo se crea una página web y cómo las puedes modificar de acuerdo a ciertas necesidades que me pidan en algún trabajo o en mi vida personal.  
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Mi primer video</h2>", unsafe_allow_html=True)
    ...
    st.video("https://www.youtube.com/watch?v=cijZGcxhS7c")
    ...
    graficos = ['Mi primer gráfico', 'Mi segundo gráfico', 'Mi primer grafico circular', 'mi primer mapa de peliculas']
    ...
    if grafico_seleccionado == 'Mi primer gráfico':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Se destaca en el gráfico de barras es una correlación directa entre disciplina y posición en la tabla. Los dos grandes, Real Madrid y FC Barcelona, muestran un promedio de 0 tarjetas rojas como local. Esto les da una ventaja táctica enorme: juegan siempre con 11 en casa. En contraste, equipos como Sevilla, Leganés y Alavés sufren una expulsión en 1 de cada 4 partidos en su estadio (promedio > 0.25), lo que condiciona severamente sus planteamientos tácticos y explica, en parte, su irregularidad.</div>", unsafe_allow_html=True)
        st.image("Grafico_barra.png", caption='Mi primer gráfico', width=500)
        pass
    elif grafico_seleccionado == 'Mi segundo gráfico':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Los histogramas muestran que el Madrid en el Bernabéu es una aplanadora (suele marcar 2, 3 o 4 goles), pero su defensa es permisiva tanto de local como de visita (casi siempre encaja entre 1 y 2 goles). Esta tendencia a partidos de muchos goles explica su gráfico circular. Por otro lado, el Madrid tiene un porcentaje de empates ínfimo (5.3%). Su estilo de juego, de golpe por golpe, hace que los partidos se rompan: o ganan por pegada (73.7% de las veces) o pierden por desprotección (21.1%). No saben especular.</div>", unsafe_allow_html=True)
        st.image("Grafico_barra1.png", caption='Mi segundo gráfico', width=500)
        pass
    elif grafico_seleccionado == 'Mi primer grafico circular':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Al corregir el segundo gráfico circular para el Barça, surge una diferencia de estilo vital respecto a su eterno rival. Aunque el Barcelona gana exactamente el mismo porcentaje de partidos que el Madrid (73.7%), su gestión de los días malos es superior.Por otro lado, el Madrid pierde el 21% de sus juegos, el Barcelona reduce sus derrotas a la mitad (10.5%) porque aceptan el empate (15.8%) como un mal menor. Esto sugiere un equipo tácticamente más equilibrado o paciente, que prefiere asegurar un punto si no puede llevarse los tres, a diferencia del vertiginoso cara o cruz del Madrid.</div>", unsafe_allow_html=True)
        st.image("Grafico_circular.png", caption='Mi primer grafico circular', width=500)
        pass
    elif grafico_seleccionado == 'mi primer mapa de peliculas':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>En este mapa interactivo nos muestra la ubicación donde se grabó cada película junto con la información adicional como el nombre de la película, director, año en que se grabó la película y su tipo de género respectivo</div>", unsafe_allow_html=True)
